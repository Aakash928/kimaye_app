      ...
      <div className="kimahiBox">
        ...
        >
          <Heading fontFamily="bitterbrush">
            WE’D LIKE TO SAY{" "}
            <span style={{ color: "rgb(197, 42, 42)" }}>KIMAHI…</span>
          </Heading>
          <div
            style={{
              textAlign: "left",
          ...
          >
            ...
            <p className="para">
              {" "}
              When it comes to fruits and vegetables, these concerns are even
              more serious in terms of the way they are grown and handled
              throughout their farm-to-home journey. We make buying and eating
              fruits and vegetables a worry-free and enjoyable experience for
              you.
            </p>
            ...
            <p className="para">
              ...
              bringing you multiple varieties of fruit and vegetables that are
          ...
          >
            <span style={{ fontWeight: "bold" }}>Kimaye</span> is #all
            <span style={{ color: "red" }}>Safe</span>#all
            <span style={{ color: "red" }}>Goods</span>
          </div>
          <div>
            <Button color="black" size="lg" borderRadius="15px">
              {" "}
              KNOW MORE{" "}
            </Button>
          </div>
